...
There is a slight negative relationship between parathyroid hormone (PTH) and urinary calcium (r = -0.15, *p* < 0.001). PTH increases renal reabsorption of calcium in order to increase serum levels. As expected, there is less urinary calcium when serum PTH concentrations are higher.
