...
ds_sub <- ds %>% 
  ...
  # group_by(mcr_status) %>%
  # mutate(n = ifelse(row_number()==n(), paste("n=", n()), NA))
  # filter(mcr_status == "Macroalbuminuria" | eGFR_status == "Moderate" | PTH_status == "PTH3")
...
cloud(UDBP ~ PTH_status + VitD_status, ds2, panel.3d.cloud=panel.3dbars, col.facet='grey', 
